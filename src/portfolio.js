...
const socialMediaLinks = [
  ...
  // {
  //   name: "X-Twitter",
  //   link: "https://twitter.com/mzyphyl",
  ...
  degrees: [
    {
      ...
      descriptions: [
        "I have studied basic software engineering subjects like DBMS, Discrete Mathematics, Programming Languases(e.g. Java, Javascript, C#) etc.",
        "Apart from this, I have done courses on Deep Learning, Database Designing, Object Oriented Programming and Full Stack Web Development.",
      ],
...
const experience = {
  ...
  description:
    "I am currently working as a systems engineer on a tech company that offers business applications.",
      ...
      experiences: [
        {
          ...
          company_url: "https://nesv.ph/",
          logo_path: "nesv-logo.png",
